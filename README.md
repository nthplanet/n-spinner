...
1. I then added a bunch of CSS animations to the global styles file. First, the N numbers are all relocated to new (x,y) positions to form a circle. And then, the entire surrounding Flex is rotated to achieve the spin.

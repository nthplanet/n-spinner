...
import NCardAnimated from "../NCard/NCardAnimated";
    ...
    <Box textAlign="center" width="full">
      ...
      >
        ...
        {transactionUrl && (
          ...
          <Box backgroundColor="black" borderWidth="4px" borderColor="gray.800" borderStyle="solid" overflow="hidden">
            <Box backgroundColor="black">
              {isMinting ? ( 
                <NCardAnimated n={selectedN} />
              ) : (
                <NCardAnimated n={selectedN}/>
              )}
            </Box>
